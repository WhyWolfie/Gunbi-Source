...
enum MMATCH_GAMETYPE {
	...
	MMATCH_GAMETYPE_DROPGUNGAME			=13,		///< DropGunGame
	MMATCH_GAMETYPE_CTF					=14,		///< Capture the flag
	MMATCH_GAMETYPE_SNIPERMODE			=15,		///< Sniper Mode
	MMATCH_GAMETYPE_CLASSICMODE			=16,
	MMATCH_GAMETYPE_CLASSICMODE_TEAM	=17,
	MMATCH_GAMETYPE_TRAINING_TEAM		=18,

	MMATCH_GAMETYPE_BLITZKRIEG			=19,
	MMATCH_GAMETYPE_WAR					=20,
...
public:
	...
	inline bool IsQuestChallengeDerived(MMATCH_GAMETYPE nGameType);
	inline bool IsBlitzOnly(MMATCH_GAMETYPE nGameType);
	inline bool IsWarOnly(MMATCH_GAMETYPE nGameType);
...
inline bool MBaseGameTypeCatalogue::IsQuestChallengeDerived(MMATCH_GAMETYPE nGameType)
{
...
inline bool MBaseGameTypeCatalogue::IsBlitzOnly(MMATCH_GAMETYPE nGameType)
{
	return nGameType == MMATCH_GAMETYPE_BLITZKRIEG;
}

inline bool MBaseGameTypeCatalogue::IsWarOnly(MMATCH_GAMETYPE nGameType)
{
	return nGameType == MMATCH_GAMETYPE_WAR;
}
...
{
	if ( nGameType == MMATCH_GAMETYPE_SURVIVAL || nGameType == MMATCH_GAMETYPE_QUEST || nGameType == MMATCH_GAMETYPE_QUEST_CHALLENGE || nGameType == MMATCH_GAMETYPE_BLITZKRIEG)
	{
		return false;
	}
