...
public:
	...
	void SetInfo(const MUID& uid, const char* szName, const char* szClanName, int nLevel,  MMatchUserGradeID nUGrade, MMatchPremiumGradeID nPGrade, MMatchClassJob nClassJob, const unsigned int nRank, const int nKillCount, const int nDeathCount, int nDTGrade )
	{
		m_uidObject = uid;
