...
#define RESPAWN_DELAYTIME_AFTER_DYING			5000	///< 죽고나서 리스폰 되는 기본 딜레이시간
#define RESPAWN_DELAYTIME_AFTER_DYING_MIN		1000	///< 죽고나서 리스폰 되는 최소 딜레이시간
...
#define CLAN_SPONSORS_COUNT			2		// 클랜생성시 필요한 발기인 수
...
#define MAX_LADDER_TEAM_MEMBER				8		// 래더팀은 1~4명까지 만들 수 있다.
...
#define MAX_WAIT_CLAN_DELETE_HOUR	(0)			// DAY_OF_DELETE_CLAN + MAX_WAIT_CLAN_DELETE_HOUR후 디비에서 클랜삭제.
...
#ifndef _LARGE_PLAYERROUND_LIMITS
...
#else
#define STAGE_MAX_PLAYERCOUNT			32  // 기본모드(퀘스트, 클래을 제외) 최대 인원. - by SungE 2007-05-14.
#define STAGE__MAX_ROUND				100000	// 스테이지에서 사용할 수 있는 최대 라운드 수. 이수를 넘을 수 없다. - By SungE 2007-11-07
#endif
// clan
#define CLAN_NAME_LENGTH				32	// 클랜 이름 최대 길이 - 이게 변경되면 프로토콜 버전도 변경되어야 함.
// 이 부분은 이전 사용자들때문에 디비에 맞추지 못함. - by SungE. 2007-03-20
#define MIN_CLANNAME					3	// 최소 4자이상 12자이하만 클랜 이름을 만들 수 있다.
#define MAX_CLANNAME					32
// character
