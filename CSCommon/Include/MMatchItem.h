...
enum MMatchMeleeItemType
{
	...
	MIT_FIGHTER = 11,
	MIT_SWORD2 = 12,
	MIT_DOUBLE_KATANA2 = 13,
	MIT_DOUBLE_KATANA3 = 14,
...
//	char					m_szItemName[128];
	...
	MProtectValue<int>		m_nLimitShield;
	...
	{
		string weapon;
		if (m_nWeaponType.Ref() == MWT_DAGGER)
			weapon = "Dagger";
		else if (m_nWeaponType.Ref() == MWT_DUAL_DAGGER)
			weapon = "Dual Dagger";
		else if (m_nWeaponType.Ref() == MWT_KATANA)
			weapon = "Katana";
		else if (m_nWeaponType.Ref() == MWT_GREAT_SWORD)
			weapon = "Great Sword";
		else if (m_nWeaponType.Ref() == MWT_DOUBLE_KATANA)
			weapon = "Double Katana";
		else if (m_nWeaponType.Ref() == MWT_PISTOL)
			weapon = "Pistol";
		else if (m_nWeaponType.Ref() == MWT_PISTOLx2)
			weapon = "Double Pistol";
		else if (m_nWeaponType.Ref() == MWT_REVOLVER)
			weapon = "Revolver";
		else if (m_nWeaponType.Ref() == MWT_REVOLVERx2)
			weapon = "Double Revolver";
		else if (m_nWeaponType.Ref() == MWT_SMG)
			weapon = "Smg";
		else if (m_nWeaponType.Ref() == MWT_SMGx2)
			weapon = "Double Smg";
		else if (m_nWeaponType.Ref() == MWT_SHOTGUN)
			weapon = "Shotgun";
		else if (m_nWeaponType.Ref() == MWT_SAWED_SHOTGUN)
			weapon = "Sawed Shotgun";
		else if (m_nWeaponType.Ref() == MWT_RIFLE)
			weapon = "Rifle";
		else if (m_nWeaponType.Ref() == MWT_MACHINEGUN)
			weapon = "Machinegun";
		else if (m_nWeaponType.Ref() == MWT_ROCKET)
			weapon = "Rifle";
		else if (m_nWeaponType.Ref() == MWT_SNIFER)
			weapon = "Sniper";
		else if (m_nWeaponType.Ref() == MWT_MED_KIT)
			weapon = "Med Kit";
		else if (m_nWeaponType.Ref() == MWT_REPAIR_KIT)
			weapon = "Repair Kit";
		else if (m_nWeaponType.Ref() == MWT_BULLET_KIT)
			weapon = "Bullet Kit";
		else if (m_nWeaponType.Ref() == MWT_FLASH_BANG)
			weapon = "Flash Bang";
		else if (m_nWeaponType.Ref() == MWT_FRAGMENTATION)
			weapon = "Grenade";
		else if (m_nWeaponType.Ref() == MWT_SMOKE_GRENADE)
			weapon = "Smoke Grenade";
		else if (m_nWeaponType.Ref() == MWT_FOOD)
			weapon = "Food";
		else if (m_nWeaponType.Ref() == MWT_SKILL)
			weapon = "Skill";
		else if (m_nWeaponType.Ref() == MWT_ENCHANT_FIRE)
			weapon = "Enchant Fire";
		else if (m_nWeaponType.Ref() == MWT_ENCHANT_COLD)
			weapon = "Enchant Cold";
		else if (m_nWeaponType.Ref() == MWT_ENCHANT_LIGHTNING)
			weapon = "Enchant Lightning";
		else if (m_nWeaponType.Ref() == MWT_ENCHANT_POISON)
			weapon = "Enchant Poison";
		else if (m_nWeaponType.Ref() == MWT_POTION)
			weapon = "Potion";
		else if (m_nWeaponType.Ref() == MWT_TRAP)
			weapon = "Trap";
		else if (m_nWeaponType.Ref() == MWT_DYNAMITYE)
			weapon = "Dynamite";
		else if (m_nWeaponType.Ref() == MWT_BOWS)
			weapon = "Bows";
		else if (m_nWeaponType.Ref() == MWT_KATANA1)
			weapon = "Katana 1C";
		else if (m_nWeaponType.Ref() == MWT_KATANA2)
			weapon = "Katana 2C";
		else if (m_nWeaponType.Ref() == MWT_KATANA3)
			weapon = "Katana 3C";
		else if (m_nWeaponType.Ref() == MWT_KATANA4)
			weapon = "Katana 4C";
		else if (m_nWeaponType.Ref() == MWT_AXE)
			weapon = "AxeC";
		else if (m_nWeaponType.Ref() == MWT_BASEBALL)
			weapon = "BaseballC";
		else if (m_nWeaponType.Ref() == MWT_FIGHTER)
			weapon = "FighterC";
		else if (m_nWeaponType.Ref() == MWT_SWORD2)
			weapon = "Sword2C";
		else if (m_nWeaponType.Ref() == MWT_DOUBLE_KATANA2)
			weapon = "DBL KTN2";
		else if (m_nWeaponType.Ref() == MWT_DOUBLE_KATANA3)
			weapon = "DBL KTN3";
		else
			weapon = "NULL";
		return weapon;
