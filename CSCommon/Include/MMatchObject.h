...
struct MMatchAccountInfo
{
	...
	MMatchAccountInfo() : m_nAID(-1), m_nUGrade(MMUG_FREE), m_nPGrade(MMPG_FREE), m_nCCode(0), m_nCashCoins(0)
	{
...
public:
	...
	MMatchClassJob GetClassJob() { return m_ClassJob; }
...
#define MAX_COSTUME_TEMPLATE		4
const MINITIALCOSTUME g_InitialCostume[MAX_COSTUME_TEMPLATE][2] = 
{ 
	//  Melee - Primary - Secondary - Custom1 - Custom2 - Head	-	Body -  hands -  legs -  feets   //  Melee - Primary - Secondary - Custom1 - Custom2 - Head - Body -  hands -  legs -  feets
	{ { 135001, 999022, 682001, 600306, 30301, 520037, 521029, 522024, 523027, 524027 }, { 135001, 999022, 682001, 600306, 30301, 520537, 521529, 522524, 523527, 524527 } },	// Assasin
	{ { 135001, 8001, 4005, 600206, 30301, 520037, 521029, 522024, 523027, 524027 }, { 135001, 8001, 4005, 600206, 30301, 520537, 521529, 522524, 523527, 524527 } },	// 건파이터
	{ { 135001, 456033, 4002, 600006, 30301, 520037, 521029, 522024, 523027, 524027 }, { 135001, 456033, 4002, 600006, 30301, 520537, 521529, 522524, 523527, 524527 } },	// 애서신
	{ { 135001, 888039, 399997, 600106, 30301, 520037, 521029, 522024, 523027, 524027 }, { 135001, 888039, 399997, 600106, 30301, 520537, 521529, 522524, 523527, 524527 } },	// 스카우트
};
...
{
	{"eq_head_08", "eq_head_hair006"},
	{"eq_head_00", "eq_head_hair001"},
	{"eq_head_00", "eq_head_hair04"},
	{"eq_head_00", "eq_head_hair006"},
	{"eq_head_00", "eq_head_hair002"}		// 이건 현재 사용안함 - 나중에 다른 모델로 대체해도 됨
};
