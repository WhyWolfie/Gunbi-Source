...
enum MMATCH_MAP
{
	...
	MMATCH_MAP_AirDuel = 25,
	MMATCH_MAP_Arena = 26,
	MMATCH_MAP_Atack_Defense = 27,
	MMATCH_MAP_BlitzKrieg = 28,
	MMATCH_MAP_Colliseum = 29,
	MMATCH_MAP_DBZ = 30,
	MMATCH_MAP_Dojo = 31,
	MMATCH_MAP_DragonWay = 32,
	MMATCH_MAP_Eventroom = 33,
	MMATCH_MAP_Fortress = 34,
	MMATCH_MAP_GoldEXP = 35,
	MMATCH_MAP_Highschool = 36,
	MMATCH_MAP_Mine = 37,
	MMATCH_MAP_Multi_DTR = 38,
	MMATCH_MAP_Nagrand_Underground = 39,
	MMATCH_MAP_Skillmap = 40,
	MMATCH_MAP_StreetV2 = 41,
	MMATCH_MAP_Superflip = 42,
	MMATCH_MAP_Tower_Stairway = 43,
	MMATCH_MAP_WeaponShop_ACT = 44,
	MMATCH_MAP_Wonderland = 45,
	MMATCH_MAP_Tenchu = 46,

	MMATCH_MAP_MAX
#ifdef _LARGEMAPLIMIT
	= 255
#endif
};
