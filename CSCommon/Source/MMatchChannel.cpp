						...
						)
{
	...
	if (nType == MCHANNEL_TYPE_WAR) {
		m_nRuleType = MCHANNEL_RULE_WAR;
	}
	return true;
}
...
bool MMatchChannel::CheckLifePeriod()
{
	...
	if (nType == MCHANNEL_TYPE_PRESET || nType == MCHANNEL_TYPE_DUELTOURNAMENT || nType == MCHANNEL_TYPE_WAR) return true;
