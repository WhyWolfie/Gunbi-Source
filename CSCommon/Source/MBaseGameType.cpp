...
_InitGameType(MMATCH_GAMETYPE_DROPGUNGAME, 		MMATCH_GAMETYPE_DROPGUNGAME, 		MMATCH_GAMETYPE_DROPGUNGAME_STR, 	  1.0f, 		1.0f, 					0.0f);
...
_InitGameType(MMATCH_GAMETYPE_CLASSICMODE,		MMATCH_GAMETYPE_CLASSICMODE,		MMATCH_GAMETYPE_CLASSIC_SOLO_STR,	  1.0f,			1.0f,					0.0f);
_InitGameType(MMATCH_GAMETYPE_CLASSICMODE_TEAM, MMATCH_GAMETYPE_CLASSICMODE_TEAM,	MMATCH_GAMETYPE_CLASSIC_TEAM_STR,	  1.0f,		    0.8f,					0.3f);
_InitGameType(MMATCH_GAMETYPE_TRAINING_TEAM,	MMATCH_GAMETYPE_TRAINING_TEAM,		MMATCH_GAMETYPE_TRAINING_TEAM_STR,	  0.0f,			0.0f,					0.0f);
_InitGameType(MMATCH_GAMETYPE_BLITZKRIEG,		MMATCH_GAMETYPE_BLITZKRIEG,			MMATCH_GAMETYPE_BLITZKRIEG_STR,		  0.0f,			0.0f,					0.0f);
_InitGameType(MMATCH_GAMETYPE_WAR,				MMATCH_GAMETYPE_WAR,				MMATCH_GAMETYPE_WAR_STR,			  1.0f,			0.6f,					0.5f);
