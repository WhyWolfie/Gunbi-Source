...
MNewQuestScenarioManager* MNewQuestScenarioManager::GetInstance()
{
	static MNewQuestScenarioManager pInstance;
	return &pInstance;
}
...
MNewQuestScenario* MNewQuestScenarioManager::ParseScenario(MXmlElement& elem)
{
	...
	pScenario->SetName(MGetStringResManager()->GetString((string)szName));
