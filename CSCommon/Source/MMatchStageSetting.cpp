...
bool MMatchStageSetting::IsTeamExtremeGame()
{
	return MGetGameTypeMgr()->IsTeamExtremeGame(m_StageSetting.Ref().nGameType);
}
...
bool MMatchStageSetting::IsQuestChallengeDerived()
{
	return MGetGameTypeMgr()->IsQuestChallengeDerived(m_StageSetting.Ref().nGameType);
}

bool MMatchStageSetting::IsBlitzOnly()
{
	return MGetGameTypeMgr()->IsBlitzOnly(m_StageSetting.Ref().nGameType);
}
