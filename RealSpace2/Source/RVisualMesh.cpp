...
void RVisualMesh::GetMotionInfo(int& sel_parts,int& sel_parts2,bool& bCheck,bool& bRender)
{
	...
	switch(m_SelectWeaponMotionType) {
		...
		case eq_ws_bows:
		{
				sel_parts = eq_parts_left_bows;
		}
			break;

		case eq_wd_katana1:
		{
			sel_parts = eq_parts_right_katana1;
		}
		break;		

		case eq_wd_katana2:
		{
			sel_parts = eq_parts_right_katana2;
		}
		break;	

		case eq_wd_katana3:
		{
			sel_parts = eq_parts_right_katana3;
		}
		break;		

		case eq_wd_katana4:
		{
			sel_parts = eq_parts_right_katana4;
		}
		break;

		case eq_wd_axe:
		{
			sel_parts = eq_parts_right_axe;
		}
		break;

		case eq_wd_baseball:
		{
			sel_parts = eq_parts_right_baseball;
		}
		break;

		case eq_wd_fighter:
		{
			sel_parts = eq_parts_right_fighter;
		}
		break;

		case eq_wd_sword2:
		{
			sel_parts = eq_parts_right_sword2;
		}
		break;

		case eq_wd_blade2:
		{
			sel_parts = eq_parts_right_blade2;
			sel_parts2 = eq_parts_left_blade2;
			bCheck = true;
		}
		break;
		...
		case eq_wd_blade3:
		{
			sel_parts = eq_parts_right_blade3;
			sel_parts2 = eq_parts_left_blade3;
			bCheck = true;
		}
		break;
...
void RVisualMesh::ShiftFugitiveValues()
{
	// AniFramInfo
	...
	{
		if (m_SelectWeaponMotionType !=
			*m_pSelectWeaponMotionType_AntiHack)
			__asm int 3;	// 클라 죽여버린다

		RWeaponMotionType* old = m_pSelectWeaponMotionType_AntiHack;
		RWeaponMotionType* New = new RWeaponMotionType;

		*New = *old;
		delete old;

		m_pSelectWeaponMotionType_AntiHack = New;
	}
}
