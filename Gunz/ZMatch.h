...
public:
	...
	inline bool IsBlitzOnly();
	inline bool IsWaitForRoundEnd();
	inline bool IsQuestDrived();
	inline bool IsQuestChallengeDrived();
...
inline bool ZMatch::IsBlitzOnly()
{
	return m_pStageSetting->IsBlitzOnly();
}
...
inline bool ZMatch::IsQuestChallengeDrived()
{
	return m_pStageSetting->IsQuestChallengeDerived();
}
