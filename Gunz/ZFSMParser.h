...
public:
	...
	ZFSM* ReadXmlNode_FSM(MXmlElement& elem);
	ZFSMState* ReadXmlNode_STATE(MXmlElement& elem);
	ZFSMTransition* ReadXmlNode_TRANS(MXmlElement& elem);
};

inline ZFSMParser* ZGetFSMParser() { return ZFSMParser::GetInstance(); }