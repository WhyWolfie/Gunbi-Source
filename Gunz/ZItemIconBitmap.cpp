	...
	case MMIST_RANGE:
		{
			MMatchWeaponType type = pItemDesc->m_nWeaponType.Ref();
			{
				...
				case MWT_SNIFER:		strcpy(szFileName, "slot_icon_sniper"); break;
				case MWT_MACHINEGUN:	strcpy(szFileName, "slot_icon_machinegun"); break;
				case MWT_ROCKET:		strcpy(szFileName, "slot_icon_rocket"); break;
				case MWT_BOWS:			strcpy(szFileName, "slot_icon_bows"); break;
				case MWT_KATANA1:			strcpy(szFileName, "slot_icon_katana1"); break;
				case MWT_KATANA2:			strcpy(szFileName, "slot_icon_katana2"); break;
				case MWT_KATANA3:			strcpy(szFileName, "slot_icon_katana3"); break;
				case MWT_KATANA4:			strcpy(szFileName, "slot_icon_katana4"); break;
				case MWT_AXE:			strcpy(szFileName, "slot_icon_axe"); break;
				case MWT_BASEBALL:			strcpy(szFileName, "slot_icon_baseball"); break;
				case MWT_FIGHTER:			strcpy(szFileName, "slot_icon_fighter"); break;
				case MWT_SWORD2:			strcpy(szFileName, "slot_icon_sword2"); break;
				case MWT_DOUBLE_KATANA2:			strcpy(szFileName, "slot_icon_doublekatana2"); break;
				case MWT_DOUBLE_KATANA3:			strcpy(szFileName, "slot_icon_doublekatana3"); break;
