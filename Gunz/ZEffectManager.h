...
#define BULLETONWALL_COUNT	2
	...
	RMesh*	m_pBlueCTFEffect;
	RMesh*	m_pRedCTFEffect;
...
//	void AddEnchantPoison(ZObject* pObj);
	...
	void AddRedCTFIcon(ZObject* pObj);
	void AddBlueCTFIcon(ZObject* pObj);
	...
	void AddWithScale(const char* szName, const rvector& pos, const rvector& dir, const MUID& uidOwner, const float& fDelay, const rvector& scale);
};
