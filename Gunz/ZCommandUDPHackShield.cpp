...
void ZCommandUDPHackShield::Init()
{
	...
	AddDeniedCommand(MC_BLITZ_NPC_SPAWN);

	AddDeniedCommand(MC_WAR_SPAWN_TOWER);
	AddDeniedCommand(MC_WAR_GAME_REQUEST_JOINGAME);
	AddDeniedCommand(MC_WAR_STAGE_JOIN);
	AddDeniedCommand(MC_WAR_NPC_DEAD);
	AddDeniedCommand(MC_WAR_SYNC_HPAP);
}
