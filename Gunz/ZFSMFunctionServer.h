...
public:
	enum {
		...
		FSMFUNC_FACE_TO_LASTEST_ATTACKER,
		FSMFUNC_RUN_WAY_POINTS_ALONG_ROUTE,
	};
public:
	ZFSMFunctionServer();
...
protected:
	...
	virtual void Func_FaceToLastestAttacker() { _ASSERT(0); }
	virtual void Func_RunWaypointsAlongRoute() { _ASSERT(0); }
private:
	int m_nDice;
};
