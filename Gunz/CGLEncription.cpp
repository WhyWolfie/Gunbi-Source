...
#define DATA_MSG_INTERNATIONAL	 "7645878573421232"
#define DATA_MSG_LAUNCHDEV		 "5687686786453242"
#define DATA_MSG_TEST			 "2312312312354545"
#define DATA_MSG_DEVILGUNZ		 "1234812135324987"
#define DATA_MSG_GUNZSLASH		 "1231238734637826"
...
int CGLEncription::Decription( void)
{
	...
	else if (strcmp(szData, DATA_MSG_DEVILGUNZ) == 0)
		return GLE_LAUNCH_INTERNATIONAL;
	else if (strcmp(szData, DATA_MSG_GUNZSLASH) == 0)
		return GLE_LAUNCH_INTERNATIONAL;
