...
void ZScreenEffectManager::Destroy()
{
	...
	SAFE_DELETE(m_pWeaponIcons[MWT_BOWS]);
	SAFE_DELETE(m_pWeaponIcons[MWT_KATANA1]);
	SAFE_DELETE(m_pWeaponIcons[MWT_KATANA2]);
	SAFE_DELETE(m_pWeaponIcons[MWT_KATANA3]);
	SAFE_DELETE(m_pWeaponIcons[MWT_KATANA4]);
	SAFE_DELETE(m_pWeaponIcons[MWT_AXE]);
	SAFE_DELETE(m_pWeaponIcons[MWT_BASEBALL]);
	SAFE_DELETE(m_pWeaponIcons[MWT_FIGHTER]);
	SAFE_DELETE(m_pWeaponIcons[MWT_SWORD2]);
	SAFE_DELETE(m_pWeaponIcons[MWT_DOUBLE_KATANA2]);
	SAFE_DELETE(m_pWeaponIcons[MWT_DOUBLE_KATANA3]);
...
#define END_(x) { _end_time = timeGetTime(); float f_time = (_end_time - _begin_time) / 1000.f; mlog("%s : %f \n", x,f_time ); }
	...
	m_pWeaponIcons[MWT_SNIFER]			= new ZScreenEffect(m_pEffectMeshMgr->Get("ef_in_icon_sniper.elu"));
	m_pWeaponIcons[MWT_BOWS]			= new ZScreenEffect(m_pEffectMeshMgr->Get("ef_in_icon_bows.elu"));
	m_pWeaponIcons[MWT_KATANA1] = new ZScreenEffect(m_pEffectMeshMgr->Get("ef_in_icon_katana1.elu"));
	m_pWeaponIcons[MWT_KATANA2] = new ZScreenEffect(m_pEffectMeshMgr->Get("ef_in_icon_katana2.elu"));
	m_pWeaponIcons[MWT_KATANA3] = new ZScreenEffect(m_pEffectMeshMgr->Get("ef_in_icon_katana3.elu"));
	m_pWeaponIcons[MWT_KATANA4] = new ZScreenEffect(m_pEffectMeshMgr->Get("ef_in_icon_katana4.elu"));
	m_pWeaponIcons[MWT_AXE] = new ZScreenEffect(m_pEffectMeshMgr->Get("ef_in_icon_axe.elu"));
	m_pWeaponIcons[MWT_BASEBALL] = new ZScreenEffect(m_pEffectMeshMgr->Get("ef_in_icon_baseball.elu"));
	m_pWeaponIcons[MWT_FIGHTER] = new ZScreenEffect(m_pEffectMeshMgr->Get("ef_in_icon_fighter.elu"));
	m_pWeaponIcons[MWT_SWORD2] = new ZScreenEffect(m_pEffectMeshMgr->Get("ef_in_icon_sword2.elu"));
	m_pWeaponIcons[MWT_DOUBLE_KATANA2] = new ZScreenEffect(m_pEffectMeshMgr->Get("ef_in_icon_double_katana2.elu"));
	m_pWeaponIcons[MWT_DOUBLE_KATANA3] = new ZScreenEffect(m_pEffectMeshMgr->Get("ef_in_icon_double_katana3.elu"));
