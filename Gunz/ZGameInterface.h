...
//	void SetupPlayerListTab();
	...
	void InitWarLobbyUI(bool bEnabled);
...
inline int KillGradeCalculate(int kill, int death)
{
	int nCalc = kill - death;

	if (nCalc <= 200 || nCalc == 200)
		return 1;
	else if (nCalc >= 200 && nCalc <= 500 || nCalc == 500)
		return 2;
	else if (nCalc >= 500 && nCalc <= 1000 || nCalc == 1000)
		return 3;
	else if (nCalc >= 1000 && nCalc <= 2000 || nCalc == 2000)
		return 4;
	else if (nCalc >= 2000 && nCalc <= 3000 || nCalc == 3000)
		return 5;
	else if (nCalc >= 3000 && nCalc <= 4000 || nCalc == 4000)
		return 6;
	else if (nCalc >= 4000 && nCalc <= 5000 || nCalc == 5000)
		return 7;
	else if (nCalc >= 5000 && nCalc <= 10000 || nCalc == 10000)
		return 8;
	else if (nCalc >= 10000 && nCalc <= 20000 || nCalc == 20000)
		return 9;
	else if (nCalc >= 20000 && nCalc <= 25000 || nCalc == 25000)
		return 10;
	else if (nCalc >= 25000 && nCalc <= 27000 || nCalc == 27000)
		return 11;
	else if (nCalc >= 27000 && nCalc <= 32000 || nCalc == 32000)
		return 12;
	else if (nCalc >= 32000 && nCalc <= 35000 || nCalc == 35000)
		return 13;
	else if (nCalc >= 35000 && nCalc <= 40000 || nCalc == 40000)
		return 14;
	else if (nCalc >= 40000 && nCalc <= 45000 || nCalc == 45000)
		return 15;
	else if (nCalc >= 45000 && nCalc <= 50000 || nCalc == 50000)
		return 16;
	else if (nCalc >= 50000 && nCalc <= 60000 || nCalc == 60000)
		return 17;
	else if (nCalc >= 60000 && nCalc <= 70000 || nCalc == 70000)
		return 18;
	else if (nCalc >= 70000 && nCalc <= 75000 || nCalc == 75000)
		return 19;
	else if (nCalc >= 75000 && nCalc <= 100000 || nCalc == 100000)
		return 20;
	else if (nCalc >= 100000)
		return 21;
	return 21;
}

inline void GetGradeKillIcon(char* out_sz, int nKills, int nDeaths)
{
	sprintf(out_sz, "ki_grade%i.png", KillGradeCalculate(nKills, nDeaths));
}

inline void GetClassJobIcon(char* out_sz, int nClassJob)
{
	sprintf(out_sz, "ClassJob_%i.png", nClassJob);
}

inline void GetDuelTournamentGradeIconFileName(char* out_sz, int grade)
{
	sprintf(out_sz, "dt_grade%i.png", grade);
}
